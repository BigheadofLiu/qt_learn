...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(260, 180, 301, 251));
        verticalLayout = new QVBoxLayout(verticalLayoutWidget);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        normalBtn = new QToolButton(verticalLayoutWidget);
        normalBtn->setObjectName("normalBtn");

        verticalLayout->addWidget(normalBtn);

        checkBtn = new QToolButton(verticalLayoutWidget);
        checkBtn->setObjectName("checkBtn");

        verticalLayout->addWidget(checkBtn);

        menuBtn = new QToolButton(verticalLayoutWidget);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        checkBtn->setText(QCoreApplication::translate("MainWindow", "...", nullptr));
