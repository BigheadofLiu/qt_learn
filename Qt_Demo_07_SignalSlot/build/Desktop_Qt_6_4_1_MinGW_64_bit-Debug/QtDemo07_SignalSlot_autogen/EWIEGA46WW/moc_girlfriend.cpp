...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GirlFriend_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_GirlFriend_t qt_meta_stringdata_GirlFriend = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_GirlFriend[] = {
...
Q_CONSTINIT const QMetaObject GirlFriend::staticMetaObject = { {
    ...
    qt_meta_stringdata_GirlFriend.offsetsAndSizes,
...
void GirlFriend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GirlFriend::*)(QString );
            if (_t _q_method = &GirlFriend::hungry; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
...
// SIGNAL 1
void GirlFriend::hungry(QString _t1)
{
