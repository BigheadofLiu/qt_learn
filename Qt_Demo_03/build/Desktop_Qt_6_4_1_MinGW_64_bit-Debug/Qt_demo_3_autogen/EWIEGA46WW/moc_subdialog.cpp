...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SubDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SubDialog_t qt_meta_stringdata_SubDialog = {
    {
        QT_MOC_LITERAL(0, 9)   // "SubDialog"
    },
    "SubDialog"
};
...
Q_CONSTINIT static const uint qt_meta_data_SubDialog[] = {
...
Q_CONSTINIT const QMetaObject SubDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_SubDialog.offsetsAndSizes,
    qt_meta_data_SubDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SubDialog_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SubDialog, std::true_type>
    >,
    nullptr
} };
