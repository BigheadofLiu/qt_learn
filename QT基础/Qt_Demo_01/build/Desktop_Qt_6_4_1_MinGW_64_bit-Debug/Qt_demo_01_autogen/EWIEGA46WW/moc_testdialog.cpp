...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TestDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TestDialog_t qt_meta_stringdata_TestDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_TestDialog[] = {
...
Q_CONSTINIT const QMetaObject TestDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_TestDialog.offsetsAndSizes,
    qt_meta_data_TestDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TestDialog_t,
        // Q_OBJECT / Q_GADGET
